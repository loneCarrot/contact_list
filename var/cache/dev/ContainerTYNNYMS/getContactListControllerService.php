 ...
 */
class getContactListControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\ContactListController' shared autowired service.
     *
     * @return \App\Controller\ContactListController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AbstractController.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'ContactListController.php';

        $container->services['App\\Controller\\ContactListController'] = $instance = new \App\Controller\ContactListController();
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'twig' => '?',
        ]))->withContext('App\\Controller\\ContactListController', $container));
